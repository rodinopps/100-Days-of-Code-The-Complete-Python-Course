...
cooking = input("Enter method of cooking: ")
burning = input("A word to describe burned food: ")
item = input("Enter household item: ")
print(cooking, food, "with", burning, plant, "on a bed of", item)
